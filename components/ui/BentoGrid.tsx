...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "oleggolo@googlemail.com";
  ...
  return (
    <div
      className={cn(
        ...
        // Add conditional class for the first element
        id === 1 ? "md:row-span-2" : "",
        className
      )}
      style={{
      ...
      {id === 1 ? (
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-5">
            <div className={cn(titleClassName, "text-center mb-4")}>
        ...
        <div className={`${id === 6 && "flex justify-center"} h-full flex flex-col`}>
          ...
          >
            ...
            {id === 6 && (
              <div className="mt-5 relative">
                ...
                <MagicButton
                  title={copied ? (language === 'en' ? "Email copied!" : "Email ist kopiert!") : (language === 'en' ? "My Email" : "Meine Email")}
                  icon={<IoCopyOutline />}
                  position="left"
